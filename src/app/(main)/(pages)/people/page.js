...
export default async function page() {
  ...
  const createPartialUser = async data => {
    ...
    sendMail({
      to: data.email,
      from: org.displayName + " via Manus Unitas <notifications@manusunitas.com>",
      replyTo: user.email,
      ...
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml">
          ...
          <body>
            <span class="preheader">${user.first_name} with ${org.displayName} has invited you to use Manus Unitas.</span>
                  ...
                  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td class="content-cell">
                              <div class="f-fallback">
                                <h1>Hi, ${newUser.first_name}!</h1>
                                <p>${user.first_name} with ${org.displayName} has invited you to use Manus Unitas to schedule events with them. Use the button below to set up your account and get started:</p>
                                <!-- Action -->
                   ...
                   https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                          <td align="center">
                                            <a href="https://manusunitas.com/set-password?id=${newUser._id}&email=${newUser.email}" class="f-fallback button" target="_blank" style="color: #FFF">Set up account</a>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
                                ...
                                <p>If you have any questions for ${user.first_name}, you can reply to this email and it will go right to them.</p>
                                <p>Welcome aboard,
                                  <br>The Manus Unitas team</p>
                                <!-- Sub copy -->
                                <table class="body-sub" role="presentation">
                                  <tr>
                                    <td>
                                      <p class="f-fallback sub">If you’re having trouble with the button above, copy and paste the URL below into your web browser.</p>
                                      <p class="f-fallback sub">https://manusunitas.com/set-password?id=${newUser._id}&email=${newUser.email}</p>
                                    </td>
                                  </tr>
                                </table>
                              </div>
